...
export default function AvenueCTA() {
  ...
  return (
    ...
    <section aria-labelledby="cta-title" className="bg-[#f3f0eb] pt-24 md:pt-32">
      <div
        ref={panelRef}
      ...
      >
        ...
        <div
          aria-hidden="true"
          className="absolute inset-0 -z-10 bg-[linear-gradient(to_right,rgba(12,10,9,0.82)_0%,rgba(12,10,9,0.55)_32%,rgba(12,10,9,0.08)_62%,rgba(12,10,9,0)_100%)]"
        />
        <div
          aria-hidden="true"
          className="absolute inset-0 -z-10 bg-[linear-gradient(to_bottom,rgba(12,10,9,0.35)_0%,rgba(12,10,9,0)_30%,rgba(12,10,9,0)_70%,rgba(12,10,9,1)_100%)]"
        />
        <div
          aria-hidden="true"
          className="absolute inset-0 -z-10 bg-[linear-gradient(to_bottom,rgba(12,10,9,0)_25%,rgba(12,10,9,0.62)_55%,rgba(12,10,9,0.8)_100%)] lg:hidden"
        />
        ...
        <div className="mx-auto flex min-h-[clamp(600px,92vh,880px)] max-w-[1450px] flex-col justify-between px-6 pb-16 pt-16 md:px-10 md:pb-20 md:pt-20 lg:px-12">
          ...
          <div ref={textRef} className="max-w-[760px]">
              ...
              {HEADING.map((line, k) => (
                <span key={k} className="block overflow-hidden pb-[0.06em]">
                  ...
                  >
                    {line.map((part, j) =>
                      part.em ? (
                        <em key={j} className="font-serif font-light normal-case italic tracking-[-0.035em] text-[#f1d4a6]">
                          {part.text}
                        </em>
                      ) : (
            ...
            <div className={`mt-9 max-w-[480px] md:mt-10 ${revealClass(textIn, "delay-300")}`}>
              ...
              <Link
                href={ENQUIRE_HREF}
                className="group mt-8 inline-flex items-center gap-3 bg-brand-gold px-8 py-4 font-grotesk text-[11px] font-semibold uppercase tracking-[0.2em] text-black transition-colors duration-300 hover:bg-white"
              >
