  ...
  return (
    <footer className="relative isolate overflow-hidden text-white">
      ...
      <div aria-hidden="true" className="pointer-events-none absolute inset-0 -z-10">
        ...
        />
        <div className="absolute inset-0 bg-[#2D3A1F]/[0.88]" />
        {/* subtle vignette */}
      ...
      <div className="border-b border-white/[0.08] px-6 py-14 text-center md:px-10 md:py-16 lg:px-12">
        ...
        <div className="mx-auto mt-5 h-px w-12 bg-[#B8A678]/50" />
      </div>
              ...
              {socials.map((social) => {
                ...
                return (
                  <a
                    ...
                    className="flex h-9 w-9 items-center justify-center rounded-full border border-white/[0.18] text-white/50 transition-all duration-300 hover:border-[#B8A678] hover:text-[#B8A678]"
                  >
              ...
              {footerProjects.map((p) => (
                <li key={p.slug}>
                  <Link
                    ...
                    className="group flex items-center gap-2 font-serif text-[17px] font-light tracking-[-0.02em] text-white/70 transition-colors duration-300 hover:text-[#B8A678]"
                  >
                    <span className="block h-px w-0 origin-left bg-[#B8A678] transition-all duration-300 group-hover:w-4" />
                    {p.name}
                  </Link>
                </li>
              ))}
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4" noValidate>
                {(
                  ...
                  <input
                    ...
                    className="border-b border-white/[0.18] bg-transparent py-2 text-[13px] text-white placeholder-white/30 outline-none transition-colors duration-300 focus:border-[#B8A678]"
                  />
                ))}

                <button
                  type="submit"
                  className="mt-1 self-start px-7 py-[11px] text-[10.5px] font-semibold uppercase tracking-[0.2em] text-[#2D3A1F] transition-opacity duration-300 hover:opacity-80"
